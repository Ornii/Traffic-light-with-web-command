...
Then run client\main.py and server\main.py (with 1 or 2 computers).

The website address is http:\\0.0.0.0:8080 by default on the computer which runs server\main.py.
